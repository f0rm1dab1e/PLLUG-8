...
//З назви функції незрозуміло, має вона повертати true коли масив пустий чи коли ні
//І в будь-якому випадку твій код можна скоротити до return !!arr.length замість великої конструкції if-else
...
//працює, але можна, знвоу ж таки, скоротити до return !!Object.keys(obj).length
